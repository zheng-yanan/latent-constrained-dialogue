...
def simple_decoder_fn_train(encoder_state, extra_information, name=None):
  ...
  """
    with ops.name_scope(name, "simple_decoder_fn_train",
      ...
      if extra_information is not None:
        cell_input = array_ops.concat([cell_input, extra_information], 1)
...
def simple_decoder_fn_inference(output_fn, encoder_state, extra_information, embeddings,
  ...
  """
    with ops.name_scope(name, "simple_decoder_fn_inference",
      ...
      if cell_output is None:
        ...
        if extra_information is not None:
          # cell_output = output_fn(cell_output, extra_information)
      ...
      if extra_information is not None:
        next_input = array_ops.concat([next_input, extra_information], 1)
